package com.example.hp.percobaan1.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    */
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor retCursor;
        int hasilMatch = sUriMatcher.match(uri);
        Log.d("Weather Provider", "Hasil matching uri="+ String.valueOf(hasilMatch));
        switch (hasilMatch) {
            // "weather/*/*"
            case WEATHER_WITH_LOCATION_AND_DATE: {
        ...
        switch (match) {
            case WEATHER: {
                if(selection!=null){
                    ...
                    rows = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, "1", selectionArgs);
                }
                break;
            }
            case LOCATION: {
                if(selection!=null){
                    ...
                    rows = db.delete(WeatherContract.LocationEntry.TABLE_NAME, "1", selectionArgs);
                }
